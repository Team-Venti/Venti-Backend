...
from .view_weekly import Weekly, BannerWeekly, PaginationTest1, PaginationTest2
...
urlpatterns = [
    ...
    path('paginations1/', PaginationTest1.as_view()),
    path('paginations2/', PaginationTest2.as_view()),
